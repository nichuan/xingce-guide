    ...
    <aside class="sidebar" :class="{ open: ui.sidebarOpen }">
      <div class="brand" @click="goHome">
        <svg class="brand-logo" viewBox="0 0 64 64" aria-hidden="true">
          ...
          <path d="M18 22h28M32 22v24M22 46h20" stroke="#fff" stroke-width="5" stroke-linecap="round" fill="none" />
      ...
      <div class="sidebar-foot">
        ...
        <a class="foot-btn" href="https://github.com/nichuan/xingce-guide" target="_blank" rel="noopener">
          <Icon name="github" />
          <span>GitHub</span>
        </a>
      </div>
